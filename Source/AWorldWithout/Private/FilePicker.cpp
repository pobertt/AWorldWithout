...
void AFilePicker::OpenFileDialog(const FString& DialogTitle, const FString& DefaultPath, const FString& FileTypes, TArray<FString>& OutFileNames)
{
	if (GEngine)
	{
...
void AFilePicker::PrintData(const FString& File)
{
